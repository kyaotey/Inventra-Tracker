...
if (isset($_GET['id'])) {
    ...
    $stmt = $conn->prepare('SELECT * FROM reports WHERE id = ? AND category = "item"');
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $category = 'item'; // Fixed category for items
    ...
    if (empty($title) || empty($description) || empty($location)) {
        ...
        if (empty($error_message)) {
            ...
            if ($stmt->execute()) {
                ...
                $success_message = "Item report submitted successfully! Your item has been added to our database.";
...
<body>
            ...
            <div class="col-lg-8">
                <div class="report-card p-5">
                    ...
                    <div class="text-center mb-4">
                        ...
                        <p class="text-muted">Help others find their lost items or report items you've found</p>
                    </div>
                    ...
                    <form method="post" enctype="multipart/form-data" id="reportForm">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="type-selector">
                                <div class="type-option" onclick="selectType('lost')">
                                    ...
                                    <h5 class="mb-2">Lost Item</h5>
                                    <p class="text-muted mb-0">I lost something</p>
                                </div>
                                <div class="type-option" onclick="selectType('found')">
                                    ...
                                    <h5 class="mb-2">Found Item</h5>
                                    <p class="text-muted mb-0">I found something</p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-8">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="title" name="title" 
                                           placeholder="e.g., iPhone 13, Red Backpack, Gold Ring" 
                        ...
                        <div class="mb-4">
                            ...
                            <div class="form-text">This will be shown to help people contact you about the item</div>
                        </div>
    ...
    <script>
        ...
        document.getElementById('reportForm').addEventListener('submit', function(e) {
            ...
            if (!type) {
                e.preventDefault();
                alert('Please select an item type (Lost or Found)');
                return false;
            }
        });
